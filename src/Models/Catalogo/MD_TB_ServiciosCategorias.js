/* Benjamin Orellana - 2026/07/14 - Modelo de categorías de servicios PREMIUM. */
...
const ServiciosCategoriasModel = db.define(
  ...
  { tableName: 'servicios_categorias', freezeTableName: true, timestamps: false }
);

export default ServiciosCategoriasModel;
