/* Benjamin Orellana - 2026/07/14 - Modelo de categorías de productos PREMIUM. */
...
const ProductosCategoriasModel = db.define(
  ...
  { tableName: 'productos_categorias', freezeTableName: true, timestamps: false }
);

export default ProductosCategoriasModel;
